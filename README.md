...
The idea of putting all my JavaScript code inside DOMContentLoaded event listener was taken from a tutorial I watched on making a card pairs memory game on YouTube by YouTuber, Ania Kubow.  The link to the video is [here](https://www.youtube.com/watch?v=tjyDOHzKN0w).  
